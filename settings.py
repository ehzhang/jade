...
MANAGERS = ADMINS
SECRET_KEY = '*7_2d###c*t9!7_vda+fh=nj$)8alda=b$j&)88!d**c8z0ste'
...
# Add extra default imports to shellplus
EXTRA_SHELLPLUS_IMPORTS = [
    'collections.Counter',
    'itertools',
...
try:
    ...
    print >> sys.stderr, dedent("""
        You appear to have a settings_local.py file, but it does not have an
        update_settings function. See the settings_local.py.template in the
        setup directory.""")
    sys.exit(1)
else:
